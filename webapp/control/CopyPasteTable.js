sap.ui.define([
	...
	return Table.extend("demonewcassini.controller.MassUpload", {
		onInit: function() {
		...
		insertRows:function(value,table,model,startRowIndex,startProperty){
			...
			var itemsArray = table.getModel("UploadModel").getProperty(itemsPath);
			var startPropertyIndex = 0;
			var model = table.getModel("UploadModel");
